...
import resume from './Andy Ho Resume.pdf';
    ...
    <div id="App">
        ...
        <div className="container">
          ...
          <nav>
            <ul className="navigation-bar">
              ...
              <li><a href="#skill-anchor" >Skills</a></li>
              <li><a href="#project-anchor">Projects</a></li>
      ...
      <section id = "home">
        <div className = "about">
          ...
          <div className = "bio-format">
            <h2 className = "bio">Hi, I am a full stack software engineer who enjoys the process of problem-solving and the act of learning new technologies. My passion for software development is coupled with my curiosity and imagination. After spending over 1000+ hours coding during Hack Reactor, I have developed strong technical skills and important soft skills that I can implement to explore the possibilities and problems found in technology.</h2>
            <br></br>
      ...
      <br></br>
      <section id = "contact">
        <h1 id = "personal-name">Contact</h1>
        <div className = "contact-stack">
          <Stack direction = "row" spacing = {10}>
            <IconButton aria-label = "Andy Ho LinkedIn" onClick = {() => window.open("http://linkedin.com/in/andy-shho")}>
              <LinkedInIcon className = "contact-icon" />
            </IconButton>
            <IconButton aria-label = "Andy Ho Github" onClick = {() => window.open("http://github.com/andy-shho")}>
              <GitHubIcon className = "contact-icon"/>
            </IconButton>
            <IconButton aria-label = "Andy Ho Email" onClick = {() => window.location = 'mailto:andyho66@gmail.com'}>
